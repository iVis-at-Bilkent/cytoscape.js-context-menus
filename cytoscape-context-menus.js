...
var context_menu_MenuItem = /*#__PURE__*/function (_HTMLButtonElement) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function _createSubmenu() {
      ...
      var indicator = this.scratchpad['submenuIndicatorGen']();
  ...
  _createClass(ContextMenu, [{
    ...
    value: function moveBefore(menuItem, before) {
      ...
      if (parent instanceof MenuItemList) {
        if (this.contains(parent)) {
          if (parent === this) {
            _get(_getPrototypeOf(ContextMenu.prototype), "moveBefore", this).call(this, menuItem, before);
          } else {
        ...
        throw new Error("parent(id=".concat(parent.id, ") is not a menu"));
      }
    }
  }], [{
    key: "define",
