...
var context_menu_MenuItem = /*#__PURE__*/function (_HTMLButtonElement) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function hasSubmenu() {
      return this.submenu instanceof context_menu_MenuItemList;
    }
  }, {
    ...
    value: function _createSubmenu() {
      ...
      this.submenu = new context_menu_MenuItemList(this.onMenuItemClick, this.scratchpad);
...
var context_menu_MenuItemList = /*#__PURE__*/function (_HTMLDivElement) {
...
var context_menu_ContextMenu = /*#__PURE__*/function (_MenuItemList) {
  ...
  _createClass(ContextMenu, [{
    ...
    value: function removeMenuItem(menuItem) {
      ...
      if (parent instanceof context_menu_MenuItemList && this.contains(parent)) {
    ...
    value: function insertMenuItem(menuItem) {
      ...
      if (typeof before !== 'undefined') {
        if (this.contains(before)) {
          ...
          if (_parent instanceof context_menu_MenuItemList) {
    ...
    value: function moveToSubmenu(menuItem) {
      ...
      if (oldParent instanceof context_menu_MenuItemList) {
...
function contextMenus(opts) {
  ...
  var bindHideCallbacks = function bindHideCallbacks() {
    var onClick = function onClick(event) {
      var cyContainer = cy.container(); // Hide only if click is outside of the Cytoscape area
  ...
  if (opts !== 'get') {
    ...
    context_menu_MenuItemList.define();
    ...
    var scratchpad = cy.scratch('cycontextmenus');
    cxtMenu = new context_menu_ContextMenu(onMenuItemClick, scratchpad);
